...
Example
	...
	unsuitable for bots (not just the room directly beneath it).
...
func matrixElementsSum(matrix [][]int) (total int) {
	nRoomsPerFloor := len(matrix[0])
	for i := 0; i < nRoomsPerFloor; i++ {
